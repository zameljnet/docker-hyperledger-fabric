...
# Chaincode edu related
CC_EDU_NAME="marbles"
CC_EDU_PATH="examples/chaincode/go/edu"
CC_EDU_INIT_ARGS='{"Args":["init","a","100","b","200"]}'
CC_EDU_UPGRADE_ARGS='{"Args":["upgrade","a","100","b","200"]}'
CC_EDU_INVOKE_ARGS='{"Args":["invoke","a","b","10"]}'
CC_EDU_QUERY_ARGS='{"Args":["query","a"]}'
...
CC_NAME=${CC_EDU_NAME}
CC_PATH=${CC_EDU_PATH}
CC_INIT_ARGS=${CC_EDU_INIT_ARGS}
CC_INIT_VERSION=v4
CC_UPGRADE_ARGS=${CC_EDU_UPGRADE_ARGS}
CC_UPGRADE_VERSION=1.1
CC_INVOKE_ARGS=${CC_EDU_INVOKE_ARGS}
CC_QUERY_ARGS=${CC_EDU_QUERY_ARGS}

# unique chaincode params
#CC_NAME=${CC_MARBLES_NAME}
#CC_PATH=${CC_MARBLES_PATH}
#CC_INIT_ARGS=${CC_MARBLES_INVOKE_INIT_ARGS}
#CC_INIT_VERSION=1.0
#CC_UPGRADE_ARGS=${CC_MARBLES_UPGRADE_ARGS}
#CC_UPGRADE_VERSION=1.1
#CC_INVOKE_ARGS=${CC_MARBLES_INVOKE_INIT_ARGS}
#CC_QUERY_ARGS=${CC_MARBLES_QUERY_READ_ARGS}
